// AN 23-12-11 we need more than what ace provides so we add things we need here, ideally should be done via build like they r doing, unfortunately their define is passing us a empty exports which we need to manually set
...
function(require, exports, module) {
    ...
    //copy over to actual exports
    for (var key in localExports) {
        exports[key] = localExports[key];
    }
...
define("ace/narcissus/jslex", ['require', 'exports', 'module', 'ace/narcissus/jsdefs'],
function(require, exports, module) {
    ...
    var localExports = { Tokenizer: Tokenizer };
    //copy over to actual exports
    for (var key in localExports) {
        exports[key] = localExports[key];
    }
...
define("ace/narcissus/jsparse", 
['require', 'exports', 'module', 'ace/narcissus/jsdefs', 'ace/narcissus/jslex'],
function(require, exports, module) {
